...
-   `session-content`
    ...
    -   `call-da-plotz.html` is a cheatsheet of plots than can be used at various points to illustrate issues if questions arise. `glossary.html` contains a glossary of statisticl terms for participants' use.
