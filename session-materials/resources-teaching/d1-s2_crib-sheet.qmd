...
::: columns
::: column
![](../images/d1-s2_session-outline.png)
:::
...
-   Awareness that own (un)conscious biases affect interpretation of uncertainty.
...
-   These are examples of uncertainty we can identify.
...
:   Recognize that sometimes it is difficult to update our pre-existing world view.
    We all have preconceived notions, i.e., this is normal, but it can become a problem if they blind us to patterns in out data.
    Discuss how different types of bias affect our judgements.
...
-   **Data biases**
    -   Selection bias
        -   If ads target a particular demographic, it might be easy to assume that everyone is similar to the respondents, when really they could be a very distinct subset.
    -   Survivor effects
        -   How do customers that don't churn (survivors) affect perceptions
...
Appropriate management of uncertainty will depend on both where the uncertainty originates, and how we perceive and interact with the causes (i.e. the two previous topics).
...
**Aim:** To try and set expectation that, since uncertainty exists, and we cannot completely remove it, we need to learn to *embrace* it.

::: {.callout-important icon="false" collapse="true"}
## Since we can't beat it, let's plan for it

-   What if everyone else (i.e. competitors) manages uncertainty better that you?
-   Is there any danger of overcompensating?
    -   i.e. trying to plan for too many possibilities?
-   **This would be a good time to hint at some kind of modelling approach**
:::
...
-   What disadvantages might associated with planning for uncertainty?
:::
