...
![Analytics maturity model (image by CC, derived from Davenport and Harris, 2007, *Competing on analytics*)](../images/analytics-maturity-model.png){#fig-analytics-maturity alt="More difficult levels of maturity yield higher value, from: descriptive, to diagnostic, to predictive, to prescriptive analyses." width="70%"}
...
See [Shmueli, G. (2010) To explain or predict](https://projecteuclid.org/journalArticle/Download?urlId=10.1214%2F10-STS330){.external target="_blank"} for an accessible, if somewhat academic, discussion on the differences between descriptive, explanatory, and predictive models
:::
...
![Current sales slump is predicted to continue.](../images/sales-forecast.png) Notice the shaded area of probability.
:::
