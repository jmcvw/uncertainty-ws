...
![](../images/egregious-plot_mil-spend_fixed.png){width="60%"}
...
![](../images/egregious-plot_height_fixed.jpg){width="60%"}
...
![](../images/egregious-plot_height_fixed-minimal.png){width="60%"}
...
![Which graph to use depends on its purpose.](../images/best_graph.png){#fig-best-graph alt="Graphs can be used for comparison, or to show connections, distributions or composotion"}
