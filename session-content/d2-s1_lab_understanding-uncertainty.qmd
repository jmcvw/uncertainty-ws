...
Change the input below that called "Spread of values", to 50, hit ![](images/btn--new-sample.png){width="107" alt="\"New sample\""} a few more times.
...
![CI covers expected value](images/plot-ci-covers-expected.png){alt="Observed value is 90, but the upper limit of the margin of error extends to 105."}

![CI does not cover expected value](images/plot-ci-misses-expected.png){alt="Observed value is 93, and the upper limit of the margin of error stops at 98, below the expected value."}

Has the weeks sales actually been different from the expectation?
:::
:::
