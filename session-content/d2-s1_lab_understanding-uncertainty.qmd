...
It is where those of you who like to know *"why"* will begin to engage with the answers to those questions.
...
Please write anything that occurs down because some of these will be referred to at later points in the activity.
...
Their stock include specialist items like flooglebinders, dooflickers, hingmies, ans well as more prosaic items like widgets, watsits, and doodahs.
The great thing about this stock is that all items sell at (their own) consistent rates throughout the year.
That is to say, that are entirely unaffected by season or cyclic trends, or world events, such as economic catastrophes or pandemics.
The average weekly sales value of sales made by this business is exactly £100.
...
![Profit for the week following website changes](images/plot--improved-sales.png){#fig-improved-profit fig-align="left" width="40%" alt="The profit observed in the week following improvements to the website was £109.66"}
...
Now... unbeknownst to The Boss we have somehow acquired superhero like powers that allow us to see how/whether sales continue to respond to our marketing campaign.
We have the ability to simulate what the observed value might be like in future weeks, by pressing the ![](images/btn--new-sample){width="108" alt="\"New sample\""} button.
...
Change the input below that is called "Spread of values", to 50, hit ![](images/btn--new-sample.png){width="107" alt="\"New sample\""} a few more times.
...
![](images/vb--ci-known-sig.png){width="250" alt="Value box displaying a margin of error of 102.5-118.2. The title bar of the box is green indicating that the margin of error does not cover the expected value of 100."}
:::
...
![Possible distibution of average weekly sales.](images/plot--part-1-summary.png){#fig-summary-bell-curve width="40%" fig-align="left" alt="Bell shaped curve centred over 100"}
...
::: columns
::: column
![](images/vb--p-998.png){width="210" fig-align="center" alt="Value box showing a p-value of 0.998. The title bar is blue indicating the results is non-significant."}

![](images/vb--pval-sig.png){width="213" fig-align="center" alt="Value box showing a p-value of 0.013. The title bar is green indicating the results is different from the expected result to a meaningful degree."}
:::
...
Discuss how this relates to our previous discussion (box 11).

![Comparison of old (black) and new (red) weekly sales distributions indicating that our new customers do indeed come from a different base.](images/plot--part-2-bell-comparison.png){#fig-dist-comparison width="40%" fig-align="left" alt="Two bell shaped curves, one centred over 100, another, narrower, one centred over 140."}
:::
...
4.  The Boss wants to try a new marketing campaign.
    -   Hit the ![](images/btn--new-campaign){width="122" height="40" alt="New campaign"} button at the top of the menu bar to target a different customer base, and start again!
...
-   Give a summary of part 2
-   Summarize most important learning points from whole session
...
-   Explored how to tell if a sample belongs to the same population or a different one (Box 12.).
...
By experimenting with the way sample size and variance interact we have seen how - If we engage with it we can learn more about the processes of importance to us
