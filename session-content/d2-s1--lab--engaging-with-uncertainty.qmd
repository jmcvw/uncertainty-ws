...
![Sample average (observed) vs expected average](images/improved-sales.png){#fig-exp-vs-sample alt="Plot showing a horizontal line labelled \"Expected\" at y" fig-align="left" width="40%"}
...
We have the ability to simulate what the observed value might be like in some of these other realities, by pressing the ![](images/btn--new-sample.png){width="108"} button.
...
![](images/input--n-sales-5.png){display="inline" width="300"}
...
![](images/input--cb-show-sales.png){width="300"}
...
Press the ![](images/btn--new-sample.png){alt="new sample" width="108"} button several more times.
...
Now change the "Number of sales" input to 20, and try several new samples (press ![](images/btn--new-sample.png){alt="new sample" width="107"}).
...
Change this input to 50, hit ![](images/btn--new-sample.png){alt="new sample" width="107"} a few more times.
...
hist(colMeans(replicate(100, (sample(85:105, 5, T)))))
hist(colMeans(replicate(100, (sample(80:90, 5, T)))))
sd(80:90)
sd(85:105)
```
...
![](images/input-n100-s50.png){width="250"}

![](images/vb--ci-unknown.png)

![](images/input--cb-show-moe-sales.png){width="250"}

![](images/vb--ci-known-sig.png)
:::
...
![](images/input--rb-ci-95.png){width="250"}
...
::: columns
::: column
![](images/vb--p-998.png){width="210"}

![](images/vb--pval-sig.png){width="213"}
:::
...
It work on pass/fail basis based on a hard threshold.
...
![](images/plot--distrs-sig-neg.png){width="30%"}
:::
...
Hit ![](images/btn--new-sample.png){alt="new sample" width="107"} enough times to fill your table.
...
Hit the ![](images/btn--new-sample.png){width="108"} button a few times, use what we have already learned today to try and get a p-value below the threshold.
...
4.  The Boss wants to try a new marketing campaign.
    -   Hit the ![](images/btn--new-campaign.png){width="122" height="40"} button at the top of the menu bar to target a different customer base, and start again!
