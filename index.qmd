...
[Glossary](session-content/glossary.html){.external target="_blank"} of statistical terms used during the workshop.
...
-   Resources
    -   [Session notes](session-content/d2-s1_lab_understanding-uncertainty.html){.external target="_blank"}
...
-   Case study links
    -   All [(html)](session-content/d2-s2_case-studies.html){.external target="_blank"}
    -   Progressive Insurance [(pdf)](session-content/d2-s2_case-study_progressive.pdf){.external target="_blank"}
    -   Allrecipes [(pdf)](session-content/d2-s2_case-study_allrecipies.pdf){.external target="_blank"}
